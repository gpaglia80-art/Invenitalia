...
Object.assign(TR.en, {
  ...
  transport: {
    ...
    hubs: [
      ...
      { icon:"🚊", label:"Tram Stops",     sub:"Tram & light-rail stops",          q:"tram station {c} Italy" },
...
Object.assign(TR.it, {
  ...
  transport: {
    ...
    hubs: [
      ...
      { icon:"🚊", label:"Fermate Tram",      sub:"Fermate tram e metro leggera",      q:"fermata tranvia {c} Italia" },
